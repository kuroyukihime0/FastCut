# FastCut - Simple Video Clipper

A fast and simple video clipping tool built with PyQt6 and FFmpeg.

## Features

- **Drag & Drop**: Load videos by dragging them into the application
- **Visual Timeline**: Interactive range slider with draggable handles
- **Precise Selection**: Set start and end points with millisecond precision
- **Keyboard Shortcuts**: 
  - `C` - Set start point
  - `V` - Set end point
